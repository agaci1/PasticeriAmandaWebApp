...
export function HomeMainShowcase() {
  ...
  return (
    <section ref={ref} className="relative z-[2] bg-[#F5F1EA] py-14 sm:py-16">
      <motion.div
        style={{ y }}
      ...
      >
        ...
        <MediaZoomFrame className="min-h-[min(70vh,520px)] rounded-sm shadow-[0_24px_80px_rgba(28,28,30,0.12)]">
          <video
            ref={videoRef}
