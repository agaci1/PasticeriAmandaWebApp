  ...
  return (
    <div className="container mx-auto py-8 px-4 min-h-[calc(100vh-4rem)]">
      <div className="text-center mb-8">
        <h1 className="text-3xl lg:text-4xl font-bold text-royal-purple mb-2">Canceled Orders</h1>
        <p className="text-royal-blue text-lg">Orders that have been canceled by customers</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-royal-blue text-xl">No canceled orders</p>
        </div>
      ) : (
              ...
              <div className="p-6">
                <div className="space-y-3 mb-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-gray-700 font-bold">ALL{order.totalPrice}</span>
                  </div>
                  <div className="flex justify-between items-center">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white border border-gold/20 rounded-lg p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div><span className="font-semibold text-royal-blue">Price:</span> ALL{viewOrder.totalPrice}</div>
                  ...
                  <div><span className="font-semibold text-royal-blue">Status:</span> 
                    <span className={`ml-2 px-3 py-1 rounded-full text-sm font-semibold bg-red-100 text-red-800`}>
                      {viewOrder.status}
                    </span>
                  </div>
                </div>
