  ...
  return (
    <div className="container mx-auto py-8 px-4 min-h-[calc(100vh-4rem)]">
      <div className="text-center mb-8">
        <h1 className="text-3xl lg:text-4xl font-bold text-royal-purple mb-2">Pending Orders</h1>
        <p className="text-royal-blue text-lg">Manage and complete customer orders</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          <p className="text-royal-blue text-xl">No pending orders at the moment</p>
        </div>
      ) : (
                    ...
                    <>
                      <Button 
                        ...
                        onClick={async () => { 
                          ...
                          try {
                            await authenticatedFetch(`/api/orders/${order.id}/complete`, { method: "PUT" }); 
                            setConfirmId(null); 
                            fetchOrders(); 
                          } finally {
