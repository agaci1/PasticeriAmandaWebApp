...
export default function OrderHistoryPage() {
  ...
  if (loading) {
    return (
      ...
      <h1 className="text-2xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-pink-400 via-purple-400 to-pink-400 animate-pulse drop-shadow-[0_0_10px_rgba(236,72,153,0.5)]">Purchase History</h1>
      <p>Loading...</p>
    </div>
    )
  }
